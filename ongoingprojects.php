...
<body>
  ...
  <main>
    ...
    <div class="container">
      <p class="navigation-p"><a href="index">Home</a> <strong>. On Going Projects</strong></p>
    </div>
              ...
              <table class="ongoing">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="column2">Evonith Metallics Ltd.</td>
                    <td class="column3">Wardha Maharashtra</td>
                    <td class="column4">Erection of 315 TPD Oxygen and Nitrogen Plant 135 m2 Sinter Plant, Stacker
                      Reclaimer with Truck Tippler. Fabrication and Erection of Building, Technological Structures,
                      Erection of Equipment’s and Utilities.</td>
                  </tr>
                  <tr>
                    <td class="column1">2</td>
                    <td class="column2">Shyam Sel &amp; Power</td>
                    <td class="column3">Jamuria, West Bengal</td>
                    <td class="column4">Supply, Fabrication &amp; Erection of 603m3 Blast Furnace, 125 m2 Sinter Plant including erections of equipments and utilities.
                    </td>
                  </tr>
                  <tr>
                    <td class="column1">3</td>
                    <td class="column2">Jai Balaji Industries Limited</td>
                    <td class="column3">Durgapur, West Bengal</td>
                    <td class="column4">Fabrication &amp; Erection of 305m3 Blast Furnace including erections of equipments and utilities.</td>
                  </tr>
                  <tr>
                    <td class="column1">4</td>
                    <td class="column2">Jairaj Ispat Limited</td>
                    <td class="column3">Kurnool Andra Pradesh</td>
                    <td class="column4">Supply, Fabrication &amp; Erection of 388 M3 Blast Furnace and 70 m2 sinter
                      plant including erections of equipments and utilities.</td>
                  </tr>
                  <tr>
                    <td class="column1">5</td>
                    <td class="column2">Sunflag Iron &amp; Steel Company Limited</td>
                    <td class="column3">Bhandara</td>
                    <td class="column4">Fabrication and Erection of Supper Alloy Plant, Blooming and Rolling Mill including erections of equipments and utilities.</td>
                  </tr>
                  <tr>
                    <td class="column1">6</td>
                    <td class="column2">Tamil Nadu Generation and Distribution Corporation</td>
                    <td class="column3">Udangudi supercritical thermal project Tuticorin</td>
                    <td class="column4">Erection of 2 x 660 MW Boilers TG building, Structures, Bunker &amp; CCR
                      Building Structure including erections of equipments and utilities.</td>
                  </tr>
                  <tr>
                    <td class="column1">7</td>
                    <td class="column2">Srikalahasthi Pipes Limited</td>
                    <td class="column3">Tirupati, Andra</td>
                    <td class="column4">Erection of Oxygen &amp; Nitrogen Plant, Fabrication &amp; Erection of Conveying
                      system including erections of equipments and utilities.</td>
                  </tr>
                  <tr>
                    <td class="column1">8</td>
                    <td class="column2">Vedanta Limited</td>
                    <td class="column3">Bokaro</td>
                    <td class="column4">Supply and Fabrication of 1260 Blast furnace Structures including erections of equipments and utilities.</td>
                  </tr>
                  <tr>
                    <td class="column1">9</td>
                    <td class="column2">Vedanta Ltd</td>
                    <td class="column3">Goa</td>
                    <td class="column4">Supply Fabrication and Erection of Building, Technological Structures and Utilities 
                      Erection of Equipment’s for Cast House #2 including erections of equipments and utilities.</td>
                  </tr>
