...
?>
  ...
  <div class="nav-a">
    ...
    <main>
        ...
        <div class="container">
          <p class="navigation-p"><a href="index">Home</a> <strong>. Contact</strong></p>
        </div>
        <section>
                ...
                <div>
                    <div class="row">
                        <div class=" col-lg-4 col-md-6 abt-para">
                            <p>Do you have a project? Do you wish to obtain more information about our company or our
                                services? We invite you to contact us by filling out the form below.</p>
                        </div>
                    </div>
                </div>
                      ...
                      <form method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="validationDefault01" name="userName" placeholder="First name" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="validationDefault02">Last name</label>
                                <input type="text" class="form-control" id="validationDefault02" name="userLastName" placeholder="Last name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputAddress">Phone</label>
                            <input type="text" class="form-control" id="inputAddress" name="userPhone" placeholder="Phone">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="userMessage" rows="4" placeholder="Message"></textarea>
                        </div>
                        <button type="submit" name="send" class="btn btn-primary">SEND</button>
                    </form>
                    
                    </div>
                    <div class="col-md-5 hd-office">
                      <iframe src="https://www.google.com/maps/d/embed?mid=17oPr3WyYfgwZ8sP-bdSw3s6jws_fIGs&ehbc=2E312F" width="100%" height="100%"></iframe>
                    ...
                    <div class="col-md-4">
                      <div class="card-c">
                        <div class="card-body">
                          ...
                          <p class="card-text">
                            Sai Building, 2nd Floor, MM Ali Road, Corporation No-60/2228, Kozhikode-673002, Kerala.</p>
                          <a href="tel:0495-2562177" class="">Tel: 0495-4607803</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="card-c">
                        <div class="card-body">
                          ...
                          <p class="card-text">MCK Tower, A K Colony Road, Jannapura, Bhadravathi-577301, 
                            Shivamogga (Dist), Karnataka</p>
                          <a href="tel:+91 9895 445914" class="">Tel: +91 9895 445914</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="card-c">
                        <div class=" card-body">
                          <h5 class="card-title">REGIONAL OFFICE (GOA)</h5>
                          <p class="card-text">Mauli Apartment, Ground Floor, Shop No-3/4, La-marcela-colony, College Road, Marcel Taluk-Ponda, Goa-403107</p>
                          <a href="tel:+91 9049 991730" class="">Tel: +91 9049 991730</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="card-c">
                        <div class=" card-body">
                          <h5 class="card-title">WORK SHOP (BHILAI)</h5>
                          <p class="card-text">22/F , Heavy Industrial Area , Hathkhoj P.O, Bhilai, Durg Dist, Chhattisgarh,- 490024 
                        </p>
                          <a href="tel:0788-2288201" class="">Tel: 0788-2288201</a>
                          <a href="tel:+918600106724" class="">Tel: +918600106724</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="card-c">
                        <div class=" card-body">
                          <h5 class="card-title">WORK SHOP (HIRIYUR)</h5>
                          <p class="card-text">MCK BLDG. Opp. Kirloskar Ferrous Industries Ltd. Paramenahally Village, Hiriyur Thaluk, Chitradurga Dist. Karnataka, Pin: 577598
                        </p>
                        <a href="tel:+918089055541" class="">Tel: +91 8089055541</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="card-c">
                        <div class=" card-body">
                          <h5 class="card-title">REGIONAL OFFICE (M.P)</h5>
                          <p class="card-text">143, Kutty’s, Bazariya Ward No.2, Garhi Mohalla, Near Chaman Chowk Damoh Dt, Madhya Pradesh-470661
                        </p>
                          <a href="tel:+91 7869 688786" class="">Tel: +91 7869 688786</a>
                        </div>
                      </div>
                    </div>
                  </div>
